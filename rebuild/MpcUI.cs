...
namespace MultiplayerCampaign
{
    public sealed class MultiplayerCampaignVM : ViewModel
    {
        ...
        [DataSourceProperty]
        public string Slot1Name { get { return MpcCharacterSlots.GetName(0); } }
        [DataSourceProperty]
        public string Slot2Name { get { return MpcCharacterSlots.GetName(1); } }
        [DataSourceProperty]
        public string Slot3Name { get { return MpcCharacterSlots.GetName(2); } }
        ...
        [DataSourceProperty]
        public bool HasSelectedCharacter { get { return MpcCharacterSlots.HasSelectedCharacter; } }
        ...
        public void ExecuteOpenCreate()
        {
            ...
            ShowCreate = false;
            ShowJoin = false;
            StatusText = "CREATE YOUR CHARACTER";
            RefreshCharacterState();
        }
        ...
        public void ExecuteCreateCharacter()
        {
            ...
            string name = string.IsNullOrWhiteSpace(CharacterName) ? "Player" : CharacterName.Trim();
